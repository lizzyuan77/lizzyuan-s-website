...
image: assets/simpsons-paradox-comic-v2.png
image-alt: "Lisa, Bart, and Homer Simpson explain how different mixes of easy and hard shots reverse an overall ranking."
lang: en
format:
  html:
...
![Different mixes, different winners. This AI-generated teaching comic depicts Lisa, Bart, and Homer Simpson in a fictional classroom example; it is not a scene from the television series.](assets/simpsons-paradox-comic-v2.png){#fig-comic fig-alt="Four-panel comic with Lisa, Bart, and Homer Simpson: Bart wins overall, 77% to Lisa's 63%. Lisa leads at near shots, 90% to 80%, and far shots, 60% to 50%. She explains that she took mostly hard shots."}
